...
const DEFAULT_CONFIGS = {
  ...
  // 'site.iconApi': 'https://www.faviconextractor.com/favicon/{domain}?larger=true', //原始图标方案
  'site.iconApi': 'https://favicon.duowenit.com/favicon/{domain}?larger=true',  // 百度图标方案
